...
print("------------Proof of Work (PoW) with Random Nounce ------------")
for a in pow_run:
    print("Difficulty Level ", pow_run.index(a) + 2, " Time Taken : ", round(a,5))

print("------------Proof of Work (PoW) with Iterative Nounce ------------")
for a in pow2_run:
    print("Difficulty Level", pow2_run.index(a) + 2, " Time Taken: ", round(a,5))
